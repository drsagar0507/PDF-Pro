    ...
    <div className="flex flex-wrap items-center gap-1 border-b border-neutral-200 bg-white px-4 py-2 dark:border-neutral-800 dark:bg-neutral-900">
      ...
      <div className="flex items-center gap-1.5">
        {signatures.map((sig) => (
          <div key={sig.id} className="group relative">
            <button
              ...
              className={`flex h-8 w-16 items-center justify-center rounded-md border bg-white p-1 dark:bg-neutral-800 ${
        ...
        <button
          ...
          className="flex h-8 items-center gap-1 rounded-md border border-dashed border-neutral-300 px-2 text-xs text-neutral-500 hover:border-indigo-400 hover:text-indigo-600 dark:border-neutral-700"
        >
